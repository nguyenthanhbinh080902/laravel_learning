       ...
       <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
          ...
          <div class="owl-carousel owl-theme c-theme owl-bordered1 c-owl-nav-center" data-items="6" data-desktop-items="4" data-desktop-small-items="3" data-tablet-items="3" data-mobile-items="2" data-slide-speed="5000" data-rtl="false">
             <div class="item">
                <a href="{{ route('dichvu') }}" >
                    <img 
                    src="{{ asset('frontend/images/vHPm7XyQah_1623147701.jpg') }}" 
                    alt="Trang cá nhân nickvn"/>
                </a>
             </div>
             <div class="item">
                <a href="{{ route('dichvu') }}" >
        ...
        <div class="col-sm-3 col-xs-6 p-5">
            ...
            <div class="news_image">
                ...
                <a href="{{ route('danhmuc', [$cate->slug]) }}" title="{{ $cate->title }}" class="">
                    <img style="width: 100%; height: 200px" src="{{ asset('uploads/category/'.$cate->image) }}" alt="{{ $cate->title }}">
                </a>
            </div>
