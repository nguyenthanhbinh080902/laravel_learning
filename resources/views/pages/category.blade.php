             ...
             <div class="row row-flex-safari game-list">
                <div class="col-sm-3 col-xs-6 p-5">
                   <div class="classWithPad">
                      ...
                      <div class="news_title">
                         <h2>
                            <a href="{{ route('danhmuccon','nick-lien-quan') }}" title="Danh Mục Game Free Fire">Danh Mục Game Free Fire</a>
                         </h2>
                      </div>
                         ...
                         <div class="row">
                            <div class="col-xs-12">
                               <div class="custom74 view">
                                  <a href="{{ route('danhmuccon','nick-lien-quan') }}" class="" title="Danh Mục Game Free Fire">
                                     &nbsp;
                                     <style type="text/css">
                                        .custom74{
                ...
                <div class="col-sm-3 col-xs-6 p-5">
                   <div class="classWithPad">
                      ...
                      <div class="news_title">
                         <h2>
                            <a href="{{ route('danhmuccon', 'nick-lien-quan') }}" title="Danh Mục Game Liên Minh">Danh Mục Game Liên Minh</a>
                         </h2>
                      </div>
                      <div class="news_description">
                         <p>
                         ...
                         <div class="row">
                            <div class="col-xs-12">
                               <div class="custom75 view">
                                  <a href="{{ route('danhmuccon', 'nick-lien-quan') }}" class="" title="Danh Mục Game Liên Minh">
                                     &nbsp;
                                     <style type="text/css">
                                        .custom75{
                                        border: none!important;
