    ...
    <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
       <div class="container">
          <div class="c-page-title c-pull-left">
             <h3 class="c-font-uppercase c-font-sbold"><a href="#" title="Blog tin tức">{{ $blogs->title }}</a></h3>
          </div>
       ...
       <div class="container">
          <div class="row">
             <div class="col-md-9">
               ...
               <p>{{  $blogs->content  }}</p>
               <img src="{{ asset('uploads/blog/'.$blogs->image) }}"
               style="width: 600px; height: 400px; margin-left: 100px" alt="">
             </div>
             <div class="col-md-3">
