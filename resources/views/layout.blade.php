...
<html lang="vi">
   ...
   <body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse">
               ...
               <div class="c-navbar-wrapper clearfix">
                  <div class="c-brand c-pull-left">
                     <div style="margin: 0px;display: inline-block">
                        ...
                        <img height="35px"
                           src="{{ asset('frontend/images/0jjbYp7OmJ_1623164374 (1).gif') }}"
                  ...
                  <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold d-none hidden-xs hidden-sm">
                     <ul  class="nav navbar-nav c-theme-nav">
                        ...
                        <li class="c-menu-type-classic">
                           ...
                           <a  rel=""  href="{{ route('video-highlight') }}" class="c-link dropdown-toggle ">Video<span class="c-arrow c-toggler"></span></a>
                        </li>
                        <li class="c-menu-type-classic">
                           ...
                           <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left " >
                              <li class="c-menu-type-classic"><a  rel="" href="{{ route('blogs') }}" class="">Blogs</a></li>
      ...
      <div class="c-layout-page">
         ...
         <div class="c-content-box">
            <div id="slider" class="owl-theme section section-cate slideshow_full_width ">
               <div id="slide_banner" class="owl-carousel">
                  ...
                  <div class="item">
                     <a href="#" alt="{{ $slid->title }}">
                     <img src="{{ asset('uploads/slider/'.$slid->image) }}" alt="{{ $slid->title }}">
                     </a>
                  </div>
                  @endforeach
               </div>
        ...
        <!--              Main          -->
        {{-- layout để lấy header và footer --}}
        @yield('content')

         <div class="modal fade" id="noticeModal" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
               <div class="loader" style="text-align: center"><img src="{{ asset('frontend/images/loader.gif') }}"
         ...
         $(document).ready(function () {
             $('.load-modal').each(function (index, elem) {
                 $(elem).unbind().click(function (e) {
                     ...
                     curModal.find('.modal-content').html("<div class=\"loader\" style=\"text-align: center\"><img src=\"{{ asset('frontend/images/loader.gif') }}\" style=\"width: 50px;height: 50px;\"></div>");
      ...
      <script src="j{{ asset('frontend/s/jquery.cubeportfolio.min.js') }}"
         type="text/javascript"></script>
